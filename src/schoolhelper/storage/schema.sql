-- school-helper — ИСХОДНАЯ схема БД (SQLite). ЗАМОРОЖЕНА.
--
-- Этот файл больше не правится: на живой базе CREATE TABLE IF NOT EXISTS не
-- добавит колонку в уже существующую таблицу. Любое изменение схемы — новая
-- миграция в storage/migrations.py. Новые таблицы — тоже туда.
--
-- Соглашения:
